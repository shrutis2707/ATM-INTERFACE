...
public class OptionMenu {
	...
	public void getChecking(Account acc) {
		...
		while (!end) {
			try {
				...
				System.out.println(" Type 2 - Withdraw AMT");
				System.out.println(" Type 3 - Deposit AMT");
				System.out.println(" Type 4 - Transfer AMT");
	...
	public void mainMenu() throws IOException {
		...
		data.put(123, new Account(904521, 783456, 20000, 50000));
		boolean end = false;
		while (!end) {
			try {
				System.out.println("\n Type 1 - Login:");
